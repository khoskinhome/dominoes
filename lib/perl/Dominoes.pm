...
sub player_select_piece {
    ...
    my $msg = sprintf("Player [%d] you have the pieces : \n  %s\n".
                ...
                " of the in-play-board. i.e 'L02' (defaults to 'R')\n".
                "     If you do pick the wrong end, the piece will automatically placed".
                " at the other end\n".
                ...
                $pieces_can_be_played_str || "[ No Valid Pieces To Play ]",
            );
